        ...
        {[
          {
            ...
            status: 'Online',
            dotColor: '#4ade80',
            dotShadow: 'rgba(74,222,128,0.35)',
            icon: '🔌',
            grad: 'linear-gradient(135deg,rgba(15,118,110,0.08),rgba(8,145,178,0.08))',
          ...
          },
          {
            ...
            dotShadow: 'rgba(74,222,128,0.35)',
            icon: '🗄️',
            grad: 'linear-gradient(135deg,rgba(22,163,74,0.08),rgba(20,184,166,0.08))',
          ...
          },
          {
            ...
            status: 'Active',
            dotColor: '#60a5fa',
            dotShadow: 'rgba(96,165,250,0.35)',
            icon: '🤖',
            grad: 'linear-gradient(135deg,rgba(8,145,178,0.08),rgba(124,58,237,0.08))',
          ...
          >
            ...
            {/* label + status */}
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: '12px', color: 'var(--color-gray-500)', fontWeight: 500, marginBottom: '4px' }}>
                {srv.label}
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                <div style={{
                  width: 8, height: 8, borderRadius: '50%',
                  background: srv.dotColor,
                  boxShadow: `0 0 0 3px ${srv.dotShadow}`,
                }} />
                <span style={{ fontSize: '14px', fontWeight: 700, color: 'var(--color-gray-800)' }}>
                  {srv.status}
                </span>
              </div>
            </div>
